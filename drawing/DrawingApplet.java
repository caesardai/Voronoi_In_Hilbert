...
/* Modes */
  ...
  public static void main(String[] args) {
    if (args != null) {
      if(args.length > 0) {
    	  ...
    	  System.out.println(FILENAME_CONVEX);
      }
      if(args.length > 1) {
    	  FILENAME_VORONOI = args[1];
    	  System.out.println(FILENAME_VORONOI);
      }
    }
  ...
  public void initButton() {
	  ...
	  this.frame.setTitle("This F***ing Thing Does Not Work!!!!");
    ...
    public void keyPressed() {
    	if(this.key == 'q') {
    		this.currentMode = (this.currentMode + 1) % DrawingApplet.MODES.length;
